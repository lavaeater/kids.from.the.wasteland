package com.lavaeater.kftw.util
...
object SimplexNoise {  // Simplex noise in 2D, 3D and 4D
    ...
    private class Grad internal constructor(//double x, y, z, w;
            internal var x: Double, internal var y: Double, internal var z: Double)/*		Grad(double x, double y, double z, double w)
		{
			this.x = x;
			this.y = y;
			this.z = z;
