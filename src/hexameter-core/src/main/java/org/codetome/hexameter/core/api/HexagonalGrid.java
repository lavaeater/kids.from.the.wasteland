...
public interface HexagonalGrid<T extends SatelliteData> {
     ...
     */
    Observable<Hexagon<T>> getHexagonsByCubeRange(CubeCoordinate from, CubeCoordinate to);
     ...
     * @return {@link Hexagon}s in the given range.
     */
    Observable<Hexagon<T>> getHexagonsByOffsetRange(int gridXFrom, int gridXTo, int gridYFrom, int gridYTo);
     ...
     */
    Optional<Hexagon<T>> getByCubeCoordinate(CubeCoordinate coordinate);
     ...
     * @return Optional with a Hexagon if it is present
     */
    Optional<Hexagon<T>> getByPixelCoordinate(double coordinateX, double coordinateY);
     ...
     */
    Optional<Hexagon<T>> getNeighborByIndex(Hexagon<T> hexagon, int index);
