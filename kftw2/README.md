...
This project uses [Gradle](http://gradle.org/) to manage dependencies. Gradle wrapper was not included by default, so you have to install Gradle locally. Useful Gradle tasks and flags:
