...
data class TileInstance(val baseSprite:Sprite, val extraSprites: Array<Sprite>, var needsHitBox: Boolean = false, val fogStatus: TileFog = TileFog.NotSeen, val tile:Tile)
