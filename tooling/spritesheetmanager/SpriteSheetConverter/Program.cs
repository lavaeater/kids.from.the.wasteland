...
namespace SpriteSheetConverter
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var path = "C:\\projects\\private\\kids.from.the.wasteland\\resources\\tileset2\\Terrain.tsx";

            var converter = new TiledConverter();
            var sheet = converter.ReadSpriteSheet(path);
